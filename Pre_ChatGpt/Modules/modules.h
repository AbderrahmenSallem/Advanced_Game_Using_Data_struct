...
typedef struct question  //   question structure
{
    char question[QMAX];
    char answer1[QMAX];
    char answer2[QMAX];
...
typedef struct type // the type which will hold the lead question and player
{
    ques *q;
}type;


typedef struct rooter // the root of the tree
{
    type *t1;
    type *t2;
    type *t3;
